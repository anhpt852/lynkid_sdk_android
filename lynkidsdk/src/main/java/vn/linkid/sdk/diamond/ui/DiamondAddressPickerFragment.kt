...
import vn.linkid.sdk.databinding.FragmentDiamondAddressPickerBinding
import vn.linkid.sdk.diamond.adapter.DiamondAddressPickerAdapter
import vn.linkid.sdk.utils.dpToPx
import vn.linkid.sdk.utils.getStatusBarHeight
import vn.linkid.sdk.utils.mainAPI

class DiamondAddressPickerFragment : Fragment() {

    private lateinit var binding: FragmentDiamondAddressPickerBinding
    ...
    private val args: DiamondAddressPickerFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        binding = FragmentDiamondAddressPickerBinding.inflate(inflater, container, false)
    ...
    private fun setUpAddressList() {
        viewModel.getAddress(parentCode, level).observe(viewLifecycleOwner) { addressList ->
            ...
            binding.apply {
                val adapter = DiamondAddressPickerAdapter(addressList.getOrNull()?.items ?: emptyList())
